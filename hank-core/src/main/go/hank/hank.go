...
//  - ConnectedAt
//  - EnvironmentFlags
type ConnectedServerMetadata struct {
  Host string `thrift:"host,1,required" db:"host" json:"host"`
  PortNumber int32 `thrift:"port_number,2,required" db:"port_number" json:"port_number"`
  ConnectedAt int64 `thrift:"connected_at,3,required" db:"connected_at" json:"connected_at"`
  EnvironmentFlags map[string]string `thrift:"environment_flags,4,required" db:"environment_flags" json:"environment_flags"`
}

func NewConnectedServerMetadata() *ConnectedServerMetadata {
  return &ConnectedServerMetadata{}
}


func (p *ConnectedServerMetadata) GetHost() string {
  return p.Host
}

func (p *ConnectedServerMetadata) GetPortNumber() int32 {
  return p.PortNumber
}

func (p *ConnectedServerMetadata) GetConnectedAt() int64 {
  return p.ConnectedAt
}

func (p *ConnectedServerMetadata) GetEnvironmentFlags() map[string]string {
  return p.EnvironmentFlags
}
func (p *ConnectedServerMetadata) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
  ...
  var issetPortNumber bool = false;
  var issetConnectedAt bool = false;
  var issetEnvironmentFlags bool = false;
  ...
  if !issetEnvironmentFlags{
    return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("Required field EnvironmentFlags is not set"));
  }
  return nil
}

func (p *ConnectedServerMetadata)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Host = v
...
func (p *ConnectedServerMetadata)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.PortNumber = v
...
func (p *ConnectedServerMetadata)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.ConnectedAt = v
...
func (p *ConnectedServerMetadata)  ReadField4(iprot thrift.TProtocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
var _val14 string
    ...
    p.EnvironmentFlags[_key13] = _val14
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
...
func (p *ConnectedServerMetadata) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("ConnectedServerMetadata"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *ConnectedServerMetadata) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("host", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:host: ", p), err) }
  if err := oprot.WriteString(string(p.Host)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.host (1) field write error: ", p), err) }
...
func (p *ConnectedServerMetadata) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("port_number", thrift.I32, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:port_number: ", p), err) }
  if err := oprot.WriteI32(int32(p.PortNumber)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.port_number (2) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:port_number: ", p), err) }
  return err
}

func (p *ConnectedServerMetadata) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("connected_at", thrift.I64, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:connected_at: ", p), err) }
  if err := oprot.WriteI64(int64(p.ConnectedAt)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.connected_at (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:connected_at: ", p), err) }
  return err
}

func (p *ConnectedServerMetadata) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("environment_flags", thrift.MAP, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:environment_flags: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.EnvironmentFlags)); err != nil {
    return thrift.PrependError("error writing map begin: ", err)
...
func (p *ConnectedServerMetadata) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("ConnectedServerMetadata(%+v)", *p)
}
...
var _elem15 float64
    ...
    p.Deciles = append(p.Deciles, _elem15)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func NewPartitionServerProcessor(handler PartitionServer) *PartitionServerProcessor {
  ...
  self22 := &PartitionServerProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self22.processorMap["get"] = &partitionServerProcessorGet{handler:handler}
  self22.processorMap["getBulk"] = &partitionServerProcessorGetBulk{handler:handler}
return self22
}
...
func NewSmartClientProcessor(handler SmartClient) *SmartClientProcessor {
  ...
  self38 := &SmartClientProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self38.processorMap["get"] = &smartClientProcessorGet{handler:handler}
  self38.processorMap["getBulk"] = &smartClientProcessorGetBulk{handler:handler}
return self38
}
