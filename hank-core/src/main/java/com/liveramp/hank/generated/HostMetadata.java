...
public class HostMetadata implements org.apache.thrift.TBase<HostMetadata, HostMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<HostMetadata> {
  ...
  public int compareTo(HostMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_flags()).compareTo(other.is_set_flags());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_host_name()).compareTo(other.is_set_host_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_host_name()) {
    ...
    lastComparison = Boolean.valueOf(is_set_port_number()).compareTo(other.is_set_port_number());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_port_number()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.port_number, other.port_number);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_environment_flags()).compareTo(other.is_set_environment_flags());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_environment_flags()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.environment_flags, other.environment_flags);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
