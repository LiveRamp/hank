...
public class HostAssignmentsMetadata implements org.apache.thrift.TBase<HostAssignmentsMetadata, HostAssignmentsMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<HostAssignmentsMetadata> {
  ...
  public int compareTo(HostAssignmentsMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_domains()).compareTo(other.is_set_domains());
    if (lastComparison != 0) {
