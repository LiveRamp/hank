...
public class RuntimeStatisticsSummary implements org.apache.thrift.TBase<RuntimeStatisticsSummary, RuntimeStatisticsSummary._Fields>, java.io.Serializable, Cloneable, Comparable<RuntimeStatisticsSummary> {
  ...
  public int compareTo(RuntimeStatisticsSummary other) {
    ...
    lastComparison = Boolean.valueOf(is_set_domain_statistics()).compareTo(other.is_set_domain_statistics());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_domain_statistics()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.domain_statistics, other.domain_statistics);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.domain_statistics = new HashMap<String,DomainStatisticsSummary>(2*_map76.size);
                for (int _i77 = 0; _i77 < _map76.size; ++_i77)
                {
                  String _key78; // required
                  DomainStatisticsSummary _val79; // required
                  _key78 = iprot.readString();
                  _val79 = new DomainStatisticsSummary();
                  _val79.read(iprot);
                  struct.domain_statistics.put(_key78, _val79);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RuntimeStatisticsSummary struct) throws org.apache.thrift.TException {
      ...
      if (struct.domain_statistics != null) {
        oprot.writeFieldBegin(DOMAIN_STATISTICS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, DomainStatisticsSummary> _iter80 : struct.domain_statistics.entrySet())
          {
  ...
  private static class RuntimeStatisticsSummaryTupleScheme extends TupleScheme<RuntimeStatisticsSummary> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RuntimeStatisticsSummary struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, DomainStatisticsSummary> _iter81 : struct.domain_statistics.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RuntimeStatisticsSummary struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.domain_statistics = new HashMap<String,DomainStatisticsSummary>(2*_map82.size);
        for (int _i83 = 0; _i83 < _map82.size; ++_i83)
        {
          String _key84; // required
          DomainStatisticsSummary _val85; // required
          _key84 = iprot.readString();
          _val85 = new DomainStatisticsSummary();
          _val85.read(iprot);
          struct.domain_statistics.put(_key84, _val85);
        }
      }
      struct.set_domain_statistics_isSet(true);
    }
