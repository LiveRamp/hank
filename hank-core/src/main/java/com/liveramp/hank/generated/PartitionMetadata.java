...
public class PartitionMetadata implements org.apache.thrift.TBase<PartitionMetadata, PartitionMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionMetadata> {
  ...
  public int compareTo(PartitionMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_num_bytes()).compareTo(other.is_set_num_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_num_bytes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.num_bytes, other.num_bytes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_num_records()).compareTo(other.is_set_num_records());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_num_records()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.num_records, other.num_records);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
