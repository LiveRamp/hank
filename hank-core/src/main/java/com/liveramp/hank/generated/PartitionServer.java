...
;
    ...
    public int compareTo(get_args other) {
      ...
      lastComparison = Boolean.valueOf(is_set_domain_id()).compareTo(other.is_set_domain_id());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_domain_id()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.domain_id, other.domain_id);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
  ...
  public static class getBulk_args implements org.apache.thrift.TBase<getBulk_args, getBulk_args._Fields>, java.io.Serializable, Cloneable, Comparable<getBulk_args>   {
...
;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.keys = new ArrayList<ByteBuffer>(_list68.size);
                  for (int _i69 = 0; _i69 < _list68.size; ++_i69)
                  {
                    ByteBuffer _elem70; // required
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getBulk_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.keys != null) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (ByteBuffer _iter71 : struct.keys)
            {
        ...
        if (struct.is_set_keys()) {
          {
            ...
            for (ByteBuffer _iter72 : struct.keys)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.keys = new ArrayList<ByteBuffer>(_list73.size);
            for (int _i74 = 0; _i74 < _list73.size; ++_i74)
            {
              ByteBuffer _elem75; // required
              _elem75 = iprot.readBinary();
              struct.keys.add(_elem75);
            }
          }
          struct.set_keys_isSet(true);
        }
  ...
  public static class getBulk_result implements org.apache.thrift.TBase<getBulk_result, getBulk_result._Fields>, java.io.Serializable, Cloneable, Comparable<getBulk_result>   {
