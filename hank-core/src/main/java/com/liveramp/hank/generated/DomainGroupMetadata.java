...
public class DomainGroupMetadata implements org.apache.thrift.TBase<DomainGroupMetadata, DomainGroupMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<DomainGroupMetadata> {
  ...
  public int compareTo(DomainGroupMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_domain_versions()).compareTo(other.is_set_domain_versions());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_domain_versions()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.domain_versions, other.domain_versions);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
