...
;
    ...
    public int compareTo(get_args other) {
      ...
      lastComparison = Boolean.valueOf(is_set_domain_name()).compareTo(other.is_set_domain_name());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (is_set_domain_name()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.domain_name, other.domain_name);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.keys = new ArrayList<ByteBuffer>(_list94.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getBulk_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.keys != null) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (ByteBuffer _iter97 : struct.keys)
            {
        ...
        if (struct.is_set_keys()) {
          {
            ...
            for (ByteBuffer _iter98 : struct.keys)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.keys = new ArrayList<ByteBuffer>(_list99.size);
            for (int _i100 = 0; _i100 < _list99.size; ++_i100)
            {
              ByteBuffer _elem101; // required
              _elem101 = iprot.readBinary();
              struct.keys.add(_elem101);
            }
          }
          struct.set_keys_isSet(true);
        }
