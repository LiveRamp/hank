...
public class HostDomainPartitionMetadata implements org.apache.thrift.TBase<HostDomainPartitionMetadata, HostDomainPartitionMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<HostDomainPartitionMetadata> {
  ...
  public int compareTo(HostDomainPartitionMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_current_version_number()).compareTo(other.is_set_current_version_number());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_current_version_number()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.current_version_number, other.current_version_number);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_deletable()).compareTo(other.is_set_deletable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_deletable()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.deletable, other.deletable);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
