...
public class DomainVersionMetadata implements org.apache.thrift.TBase<DomainVersionMetadata, DomainVersionMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<DomainVersionMetadata> {
...
;
  ...
  public int compareTo(DomainVersionMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_properties()).compareTo(other.is_set_properties());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_defunct()).compareTo(other.is_set_defunct());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_defunct()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.defunct, other.defunct);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_closed_at()).compareTo(other.is_set_closed_at());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_closed_at()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.closed_at, other.closed_at);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
