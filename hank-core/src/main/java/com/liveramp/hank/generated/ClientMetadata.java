...
public class ClientMetadata implements org.apache.thrift.TBase<ClientMetadata, ClientMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<ClientMetadata> {
  ...
  public int compareTo(ClientMetadata other) {
    ...
    lastComparison = Boolean.valueOf(is_set_connected_at()).compareTo(other.is_set_connected_at());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_connected_at()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.connected_at, other.connected_at);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
