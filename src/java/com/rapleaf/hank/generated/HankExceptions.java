...
public class HankExceptions extends org.apache.thrift.TUnion<HankExceptions, HankExceptions._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HankExceptions");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HankExceptions.class, metaDataMap);
  }

  public HankExceptions() {
    super();
  }

  public HankExceptions(_Fields setField, Object value) {
    super(setField, value);
  }

  public HankExceptions(HankExceptions other) {
    super(other);
  }
  public HankExceptions deepCopy() {
    return new HankExceptions(this);
  }

  public static HankExceptions wrong_host(boolean value) {
    HankExceptions x = new HankExceptions();
    x.set_wrong_host(value);
    return x;
  }

  public static HankExceptions no_such_domain(boolean value) {
    HankExceptions x = new HankExceptions();
    x.set_no_such_domain(value);
    return x;
  }

  public static HankExceptions zero_replicas(boolean value) {
    HankExceptions x = new HankExceptions();
    x.set_zero_replicas(value);
    return x;
  }

  public static HankExceptions internal_error(String value) {
    HankExceptions x = new HankExceptions();
  ...
  public boolean equals(Object other) {
    if (other instanceof HankExceptions) {
      return equals((HankExceptions)other);
    } else {
      return false;
    }
  }

  public boolean equals(HankExceptions other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(HankExceptions other) {
