...
public class HankResponse extends org.apache.thrift.TUnion<HankResponse, HankResponse._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.XCEPTION, new org.apache.thrift.meta_data.FieldMetaData("xception", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, HankExceptions.class)));
  ...
  public static HankResponse xception(HankExceptions value) {
    HankResponse x = new HankResponse();
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case XCEPTION:
        if (value instanceof HankExceptions) {
          break;
        }
        throw new ClassCastException("Was expecting value of type HankExceptions for field 'xception', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case XCEPTION:
          if (field.type == XCEPTION_FIELD_DESC.type) {
            HankExceptions xception;
            xception = new HankExceptions();
            xception.read(iprot);
            return xception;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
  ...
  protected void writeValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case VALUE:
        ...
        return;
      case XCEPTION:
        HankExceptions xception = (HankExceptions)value_;
   ...
   * error states
   */
  public HankExceptions get_xception() {
    if (getSetField() == _Fields.XCEPTION) {
      return (HankExceptions)getFieldValue();
    } else {
   ...
   * error states
   */
  public void set_xception(HankExceptions value) {
    if (value == null) throw new NullPointerException();
