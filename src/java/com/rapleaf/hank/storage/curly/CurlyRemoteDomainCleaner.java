...
public class CurlyRemoteDomainCleaner extends IncrementalRemoteDomainCleaner implements RemoteDomainCleaner {

  private final PartitionRemoteFileOps partitionRemoteFileOps;

  public CurlyRemoteDomainCleaner(PartitionRemoteFileOps partitionRemoteFileOps,
                                  Domain domain,
  ...
  protected DomainVersion getParentDomainVersion(Domain domain, DomainVersion domainVersion) throws IOException {
    return AbstractCurlyPartitionUpdater.getParentDomainVersion(partitionRemoteFileOps, domain, domainVersion);
  }
}
