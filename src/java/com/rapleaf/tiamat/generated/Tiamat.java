...
public class Tiamat {
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public TiamatResponse recv_get() throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public static class get_call extends TAsyncMethodCall {
      ...
      public TiamatResponse getResult() throws TException {
  ...
  public static class get_result implements TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, TiamatResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public get_result(get_result other) {
      if (other.isSetSuccess()) {
        this.success = new TiamatResponse(other.success);
      }
    }
    ...
    public TiamatResponse getSuccess() {
      return this.success;
    }

    public get_result setSuccess(TiamatResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((TiamatResponse)value);
        }
        break;
        ...
        switch (field.id) {
          case 0: // SUCCESS
            if (field.type == TType.STRUCT) {
              this.success = new TiamatResponse();
