...
import com.rapleaf.tiamat.coordinator.Coordinator.RingGroupChangeListener;
import com.rapleaf.tiamat.exception.DataNotFoundException;
import com.rapleaf.tiamat.generated.Tiamat.Client;
...
public class Handler implements Iface, RingGroupChangeListener {
  ...
  @Override
  public TiamatResponse get(byte domain_id, ByteBuffer key) throws TException {
    int partition;
    try {
  ...
  private TiamatResponse directGet(String server, byte domain_id, ByteBuffer key) throws TException {
    Client client;
