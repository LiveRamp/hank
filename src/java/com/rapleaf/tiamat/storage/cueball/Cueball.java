...
public class Cueball implements StorageEngine {
  ...
  @Override
  public Writer getWriter(OutputStreamFactory outputStream, int partNum, int versionNumber, boolean base) {
