...
public class TestHadoopDomainBuilder extends HadoopTestCase {
  ...
  public void testSorted() throws IOException {
    ...
    String p1 = getContents(fs, HdfsPartitionFileStreamFactory.getPath(OUTPUT_PATH_B, 0, "0.base"));
    String p2 = getContents(fs, HdfsPartitionFileStreamFactory.getPath(OUTPUT_PATH_B, 1, "0.base"));
    assertEquals("0 v0\n2 v2\n4 v4\n", p1);
    assertEquals("1 v1\n3 v3\n", p2);
  }
